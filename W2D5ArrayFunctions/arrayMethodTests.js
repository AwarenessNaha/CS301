...
/* 0.  Write a function that will take an index and two arrays and splice the second array
 into the first at the given position */
...
/* 2.	Write a function that checks if an array is palindrome by using push and pop 
array methods to reverse the array and then isArrayEqual method you wrote for 1.  */
...
/* 3. Write a function, reverse2String,  that transforms a given array as following. 
...
/*
    4. Write a JavaScript function named enhancedIncludes that takes two parameters, 
    an array, and a value to search in the array and return an array result with three values.
...
/* 5. Write a function, ssReverse, that returns reversed copy of a given array 
...
// - can you write a function that takes an index and an array and a newElement 
//and replaces the element at the index with the newElement?
//   e.g., frontReplace(2,[1, 2,3,4,5,6,7],99) --> [1,2,99,4,5,6,7)
// - can you write a function that takes an index and an array and a newElement
// and replaces the element at the length - 1 - index with the newElement?
//  e.g., backReplace(2,[1, 2,3,4,5,6,7],99) --> [1,2,3,4,99,6,7)
// - can you write a function that takes an index and an array and returns 
//a string with the elements at positions index and length - 1 - index
//   e.g., getIndices(2,[1, 2,3,4,5,6,7]) --> "35"*/

describe("ssReverse", function () {

    it("Solution1: [1, 2, 3, 4]", function () {
        assert.deepStrictEqual(arrays.ssReverse([1, 2, 3, 4]), [4, 3, 2, 1]);
    });
    it("Solution2: [1, 2, 3, 4]", function () {
        assert.deepStrictEqual(arrays.ssReverse1([1, 2, 3, 4]), [4, 3, 2, 1]);
    });
});
